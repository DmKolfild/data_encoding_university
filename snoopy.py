snoopy = {"extension": "snoopy", "offset": 0, "signature": b"\xAA\xAA\xAA\xAA", "version": 1, "offset_version": 4,
          "offset_code_alg": 5, "offset_size_of_file":  6, "offset_id": 12, "offset_link": 14,
          "offset_size_of_file_haffman": 46, "offset_dict_haf": 52, "offset_data": 1588}
snoopy1 = {1: {"extension": "snoopy", "offset": 0, "signature": b"\xAA\xAA\xAA\xAA", "version": 1, "offset_version": 4,
...
# (offset_data - offset_dict_haf) - число байт под словарь ключей. 2 байта - ключ, 1 байт - длина исходной кодировки,
#                                                                                                   3 байта - кодировка
